...
$NODE_LAMBDA run -x test/context.json -j test/sns-codebuild-event-status-failed.json
$NODE_LAMBDA run -x test/context.json -j test/sns-codebuild-event-status-in-progress.json
